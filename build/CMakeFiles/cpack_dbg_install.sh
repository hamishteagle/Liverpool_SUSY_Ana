...
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.11.0/Linux-x86_64/bin/cmake -E copy /user/hteagle/AnalysisDirectory/Rel21/Base.21.2.72/athena/Projects/build/x86_64-slc6-gcc62-opt/bin/*.dbg \
    ${OUTDIR}/bin/
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.11.0/Linux-x86_64/bin/cmake -E copy /user/hteagle/AnalysisDirectory/Rel21/Base.21.2.72/athena/Projects/build/x86_64-slc6-gcc62-opt/lib/*.dbg \
    ${OUTDIR}/lib/
