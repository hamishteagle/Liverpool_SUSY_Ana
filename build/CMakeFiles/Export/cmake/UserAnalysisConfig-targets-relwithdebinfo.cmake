...
# Import target "UserAnalysis::testRunGrid" for configuration "RelWithDebInfo"
set_property(TARGET UserAnalysis::testRunGrid APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(UserAnalysis::testRunGrid PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/testRunGrid"
  )

list(APPEND _IMPORT_CHECK_TARGETS UserAnalysis::testRunGrid )
list(APPEND _IMPORT_CHECK_FILES_FOR_UserAnalysis::testRunGrid "${_IMPORT_PREFIX}/bin/testRunGrid" )
