...
#define ROOTCORE_PACKAGE_JetAnalysisInterfaces
#define ROOTCORE_PACKAGE_BoostedJetTaggers
...
#define ROOTCORE_PACKAGE_HFORTools
...
#define ROOTCORE_PACKAGE_RestFrames
#define ROOTCORE_PACKAGE_NewMT2
